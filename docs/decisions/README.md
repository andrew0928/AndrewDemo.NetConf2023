...
| [2026-04-24](2026-04-24-petshop-storefront-phase1-boundary.md) | **PetShop Storefront Phase 1 邊界**。M4-P3 拆成 P3A spec/skeleton、P3B reservation flow pages、P3C member/order integration 與 browser smoke；PetShop Storefront 沿用 server-side BFF，browser 不直接持 token 呼叫 `/api` 或 `/petshop-api`，checkout 仍使用標準 cart / checkout flow。 |
